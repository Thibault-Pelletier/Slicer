...
#ifndef __vtkSegmentEditorScriptedEffect_h
#define __vtkSegmentEditorScriptedEffect_h
...
///
class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorScriptedEffect : public vtkSegmentEditorAbstractEffect
{
  Q_OBJECT

public:
  typedef vtkSegmentEditorAbstractEffect Superclass;
  vtkSegmentEditorScriptedEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorScriptedEffect() override;
...
protected:
  QScopedPointer<vtkSegmentEditorScriptedEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorScriptedEffect);
  Q_DISABLE_COPY(vtkSegmentEditorScriptedEffect);
};
