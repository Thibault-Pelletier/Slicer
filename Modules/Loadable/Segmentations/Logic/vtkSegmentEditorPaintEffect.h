...
#ifndef __vtkSegmentEditorPaintEffect_h
#define __vtkSegmentEditorPaintEffect_h
...
class vtkSegmentEditorPaintEffectPrivate;
class vtkPolyData;

class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorPaintEffect : public vtkSegmentEditorAbstractLabelEffect
{
  Q_OBJECT
...
public:
  ...
  vtkSegmentEditorPaintEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorPaintEffect() override;
...
protected:
  ...
  /// Overridden in the \sa vtkSegmentEditorEraseEffect subclass
  bool m_AlwaysErase;
...
protected:
  QScopedPointer<vtkSegmentEditorPaintEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorPaintEffect);
  Q_DISABLE_COPY(vtkSegmentEditorPaintEffect);
};
