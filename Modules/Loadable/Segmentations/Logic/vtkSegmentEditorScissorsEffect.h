...
#ifndef __vtkSegmentEditorScissorsEffect_h
#define __vtkSegmentEditorScissorsEffect_h
...
class vtkSegmentEditorScissorsEffectPrivate;
class vtkPolyData;

class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorScissorsEffect : public vtkSegmentEditorAbstractLabelEffect
{
public:
  Q_OBJECT
...
public:
  ...
  vtkSegmentEditorScissorsEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorScissorsEffect() override;
...
protected:
  QScopedPointer<vtkSegmentEditorScissorsEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorScissorsEffect);
  Q_DISABLE_COPY(vtkSegmentEditorScissorsEffect);
};
