...
#ifndef __vtkSegmentEditorScriptedPaintEffect_h
#define __vtkSegmentEditorScriptedPaintEffect_h
...
///
class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorScriptedPaintEffect : public vtkSegmentEditorPaintEffect
{
  Q_OBJECT

public:
  typedef vtkSegmentEditorPaintEffect Superclass;
  vtkSegmentEditorScriptedPaintEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorScriptedPaintEffect() override;
...
protected:
  QScopedPointer<vtkSegmentEditorScriptedPaintEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorScriptedPaintEffect);
  Q_DISABLE_COPY(vtkSegmentEditorScriptedPaintEffect);
};
