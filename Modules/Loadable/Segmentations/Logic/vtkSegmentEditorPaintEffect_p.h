...
#ifndef __vtkSegmentEditorPaintEffect_p_h
#define __vtkSegmentEditorPaintEffect_p_h
...
class vtkSegmentEditorPaintEffectPrivate : public QObject
{
  Q_OBJECT
  Q_DECLARE_PUBLIC(vtkSegmentEditorPaintEffect);

protected:
  vtkSegmentEditorPaintEffect* const q_ptr;

public:
  typedef QObject Superclass;
  vtkSegmentEditorPaintEffectPrivate(vtkSegmentEditorPaintEffect& object);
  ~vtkSegmentEditorPaintEffectPrivate() override;
