...
#ifndef __vtkSegmentEditorScriptedLabelEffect_h
#define __vtkSegmentEditorScriptedLabelEffect_h
...
///
class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorScriptedLabelEffect : public vtkSegmentEditorAbstractLabelEffect
{
  Q_OBJECT

public:
  typedef vtkSegmentEditorAbstractLabelEffect Superclass;
  vtkSegmentEditorScriptedLabelEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorScriptedLabelEffect() override;
...
protected:
  QScopedPointer<vtkSegmentEditorScriptedLabelEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorScriptedLabelEffect);
  Q_DISABLE_COPY(vtkSegmentEditorScriptedLabelEffect);
};
