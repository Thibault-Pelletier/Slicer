...
#ifndef __vtkSegmentEditorAbstractLabelEffect_h
#define __vtkSegmentEditorAbstractLabelEffect_h
...
class vtkSegmentEditorAbstractLabelEffectPrivate;
...
class VTK_SLICER_SEGMENTATIONS_LOGIC_EXPORT vtkSegmentEditorAbstractLabelEffect : public vtkSegmentEditorAbstractEffect
{
public:
  Q_OBJECT

public:
  typedef vtkSegmentEditorAbstractEffect Superclass;
  vtkSegmentEditorAbstractLabelEffect(QObject* parent = nullptr);
  ~vtkSegmentEditorAbstractLabelEffect() override;

public:
  /// Clone editor effect
  /// (redefinition of pure virtual function to allow python wrapper to identify this as abstract class)
  vtkSegmentEditorAbstractEffect* clone() override = 0;
...
protected:
  QScopedPointer<vtkSegmentEditorAbstractLabelEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(vtkSegmentEditorAbstractLabelEffect);
  Q_DISABLE_COPY(vtkSegmentEditorAbstractLabelEffect);
};
