...
#ifndef __vtkSegmentEditorAbstractEffect_p_h
#define __vtkSegmentEditorAbstractEffect_p_h
...
//-----------------------------------------------------------------------------
class vtkSegmentEditorAbstractEffectPrivate : public QObject
{
  Q_OBJECT
  Q_DECLARE_PUBLIC(vtkSegmentEditorAbstractEffect);

protected:
  vtkSegmentEditorAbstractEffect* const q_ptr;

public:
  vtkSegmentEditorAbstractEffectPrivate(vtkSegmentEditorAbstractEffect& object);
  ~vtkSegmentEditorAbstractEffectPrivate() override;
signals:
