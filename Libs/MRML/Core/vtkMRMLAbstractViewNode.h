...
public:
  ...
  //@{
  /// \brief Get/Set the logic associated with the view.
  vtkGetObjectMacro(Logic, vtkObject);
  vtkSetObjectMacro(Logic, vtkObject);
  //@}
...
protected:
  ...
  vtkWeakPointer<vtkObject> Logic = nullptr;
};
